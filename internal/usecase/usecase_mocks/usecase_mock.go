...
func (m *MockIOrderUsecase) CreateCart(ctx context.Context, userId uuid.UUID) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIOrderUsecaseMockRecorder) CreateCart(ctx, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCart", reflect.TypeOf((*MockIOrderUsecase)(nil).CreateCart), ctx, userId)
}

// DeleteCart mocks base method.
func (m *MockIOrderUsecase) DeleteCart(ctx context.Context, cartId uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockIOrderUsecaseMockRecorder) DeleteCart(ctx, cartId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCart", reflect.TypeOf((*MockIOrderUsecase)(nil).DeleteCart), ctx, cartId)
}
...
// CreateCart mocks base method.
func (m *MockIUserUsecase) CreateCart(ctx context.Context, userId uuid.UUID) (uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCart", ctx, userId)
	ret0, _ := ret[0].(uuid.UUID)
	ret1, _ := ret[1].(error)
...
// CreateCart indicates an expected call of CreateCart.
func (mr *MockIUserUsecaseMockRecorder) CreateCart(ctx, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCart", reflect.TypeOf((*MockIUserUsecase)(nil).CreateCart), ctx, userId)
}
...
// GetCartByUserId mocks base method.
func (m *MockIUserUsecase) GetCartByUserId(ctx context.Context, userId uuid.UUID) (*models.Cart, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCartByUserId", ctx, userId)
	ret0, _ := ret[0].(*models.Cart)
	ret1, _ := ret[1].(error)
...
// GetCartByUserId indicates an expected call of GetCartByUserId.
func (mr *MockIUserUsecaseMockRecorder) GetCartByUserId(ctx, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCartByUserId", reflect.TypeOf((*MockIUserUsecase)(nil).GetCartByUserId), ctx, userId)
}
