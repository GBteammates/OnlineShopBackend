...
func NewCategoryDelivery(categoryUsecase usecase.ICategoryUsecase,
	itemsUsecase usecase.IItemUsecase,
	logger *zap.SugaredLogger) *CategoryDelivery {
	return &CategoryDelivery{
		categoryUsecase: categoryUsecase,
		itemUsecase:     itemsUsecase,
		logger:          logger,
	}
}
...
func (delivery *CategoryDelivery) CreateCategory(c *gin.Context) {
...
func (delivery *CategoryDelivery) UpdateCategory(c *gin.Context) {
...
func (delivery *CategoryDelivery) UploadCategoryImage(c *gin.Context) {
...
func (delivery *CategoryDelivery) DeleteCategoryImage(c *gin.Context) {
...
func (delivery *CategoryDelivery) GetCategory(c *gin.Context) {
...
func (delivery *CategoryDelivery) GetCategoryList(c *gin.Context) {
...
func (delivery *CategoryDelivery) DeleteCategory(c *gin.Context) {
...
func (delivery *CategoryDelivery) GetCategoriesImagesList(c *gin.Context) {
